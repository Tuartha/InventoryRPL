                    ...
                    <div class="p-4 md:p-5">
                        ...
                        <div class="flex justify-center pt-5">
                            <button data-modal-hide="popup-modal" type="button"
                                class="hapusBtn text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300  font-medium rounded-lg text-sm inline-flex items-center px-7 py-2.5 text-center">
                                Hapus
                            </button>
                            <button data-modal-hide="popup-modal" type="button"
